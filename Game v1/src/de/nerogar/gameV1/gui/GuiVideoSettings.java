...
public class GuiVideoSettings extends Gui {
	...
	public void init() {
		...
		//vSync
		textLabels.add(new GElementTextLabel(genNewID(), 0.05f, 0.35f, 0.2f, 0.1f, "vertical Sync:", FontRenderer.LEFT));
		...
		//fov
		textLabels.add(new GElementTextLabel(genNewID(), 0.55f, 0.2f, 0.2f, 0.1f, "fov:", FontRenderer.LEFT));
		...
		//loaddistance
		textLabels.add(new GElementTextLabel(genNewID(), 0.55f, 0.35f, 0.2f, 0.1f, "loaddistance:", FontRenderer.LEFT));
		...
		//renderdistance
		textLabels.add(new GElementTextLabel(genNewID(), 0.55f, 0.5f, 0.2f, 0.1f, "renderdistance:", FontRenderer.LEFT));
